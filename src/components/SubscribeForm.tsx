...
import { SuccessPopup } from "@/src/components/NewsletterSignup";
...
export default function SubscribeForm() {
  ...
  return (
    <div className="max-w-[420px] mx-auto w-full">
      ...
      {/* Email input */}
      <div className="mb-4">
        <label className="font-secondary text-sm font-bold text-[#57534E] tracking-[1.5px] uppercase block mb-2">
          Email address
        </label>
        <input
          type="email"
      ...
      <div className="mb-6">
        ...
        >
          ...
          <span className="font-secondary text-sm text-[#57534E] leading-snug">
      ...
      {/* Error */}
      {error && (
        <div className="font-secondary text-sm font-semibold text-[#EF4444] mb-4 flex items-center gap-1.5">
          <span>&#9888;</span> {error}
        </div>
      )}
      ...
      {status === "success" && (
        <SuccessPopup onClose={() => router.push("/")} />
      )}
      ...
      <div className="mt-7 flex gap-4 flex-wrap">
        {reassurances.map((item) => (
          <div key={item.text} className="flex items-center gap-1.5">
            ...
            <span className="font-secondary text-sm font-medium text-dark/30">
              {item.text}
            </span>
          </div>
        ))}
      ...
      <div className="mt-12 p-6 border border-dark/8 bg-[#F2EDE6]">
        ...
        <p className="font-secondary text-sm text-[#57534E] leading-relaxed italic mb-3.5">
          The most actionable product newsletter I&apos;ve read in years. Every
          issue has at least one insight I can apply the same week.
        </p>
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 bg-primary/10 flex items-center justify-center font-secondary text-sm font-bold text-primary">
            S
          </div>
          <div>
            <div className="font-secondary text-sm font-bold text-dark">
              Sarah K.
            </div>
            <div className="font-secondary text-sm font-medium text-dark/30">
